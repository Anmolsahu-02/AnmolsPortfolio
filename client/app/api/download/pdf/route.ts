...
// Sample resume data - In production, you'd serve an actual PDF file
const resumeContent = `
ANMOL SAHU
Software Developer
...
export async function GET() {
  ...
  // or serve an actual PDF file from your public folder
  ...
  return new NextResponse(data, {
    headers: {
      ...
      "Content-Disposition": "attachment; filename=Anmol_Sahu_Resume.pdf",
    },
  })
}
